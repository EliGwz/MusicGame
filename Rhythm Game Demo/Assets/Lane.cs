...
namespace Msccs.Game.Demos {
    ...
    public class Lane : MonoBehaviour {
        ...
        void Start() {
            ...
            despawnY = Camera.main.ViewportToWorldPoint(new Vector3(0f, 0f, cameraOffsetZ)).y - 2f;//conflict with game manager
        ...
        public void CheckNoteHit() {
            ...
            if (trackedNotes.Count > 0 && trackedNotes.Peek().IsNoteHittable()) {
                Note hitNote = trackedNotes.Dequeue();
        ...
        public bool DoesMatchPayload(string payload) {
            ...
            for (int i = 0; i < matchedPayloads.Count; ++i) {
                ...
                //    break;
                //}
                if (payload.Contains(matchedPayloads[i])) {
                    bMatched = true;
                    break;
                }
            }
